...
- **Tope propio para el TEXTO (decisión de Maia, 14/9/2026).** La intervención sigue en 150 palabras; el `TEXTO` que va al acta tendrá un tope propio más alto (400 o 500, a fijar al implementar), igual para las ocho casas y declarado. Motivo: en las tres corridas base de Opus 5 el texto ómnibus pasó las 150 palabras y el script lo cortó (174, 513 y 202 palabras); en una, el acta perdió seis de nueve puntos y aun así figuró como completa (resultados/convergencia_20260914.md, sección 5). Maia: "Opus necesita más límite de palabras. Yo sé que debería adaptarse, pero nunca escribe corto y así se pierde lo que dice." No se le da un tope distinto a Opus: sería ajustar la condición a un modelo. Queda para implementar con la versión 2 (`max_palabras_texto` en la configuración, texto del turno en es.yaml/en.yaml). Las corridas de la versión 1 se quedan con el corte documentado.
