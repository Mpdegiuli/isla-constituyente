...
| Corrida | Motivo |
|---|---|
| `v2_sonnet_mono_20260914-192855_1`, `v2_sonnet_mono_horizonte_20260914-194637_1` | Artefacto del parser, no del modelo. Con el tope de 500 palabras para el TEXTO, Sonnet escribió los textos en varios párrafos ("RÉGIMEN POLÍTICO: …", "RÉGIMEN ECONÓMICO: …"); el parser tomaba solo la primera línea después de "TEXTO:" y el resto caía en la intervención libre, que se cortaba en 150 palabras: 63 de 70 turnos cortados en la base (48 de 70 en horizonte), y las propuestas que vieron las otras partes eran una sola frase ("…Se basa en los siguientes principios:"). Con eso, 62 turnos de "enmendar, pedir_votacion" sobre el régimen sin cerrar nunca (base) y sin acuerdo en las dos. Corrección en `isla/bucle.py` (`parsear_turno`: el TEXTO abarca todas las líneas hasta otra etiqueta); re-parseadas las 70 respuestas de la base con el parser corregido, 1 turno pasa de 150 y el TEXTO promedio tiene 257 palabras. Los prompts de la v1 no cambian (51 de 51 textos idénticos en `base_mono_20260913-013751_1`). Se ven en estas dos, como muestra: el nombre elegido en la base fue "República Cooperativa de la Isla" (parte 3, ronda 2, nunca votado) y en horizonte "Régimen de Supervivencia" (parte 2, aprobado 5-2 en la ronda 2). Repetidas al frente de la cola. |
| `v2_opus_mono_20260914-200328_1` | Parcial: cola detenida a mano en la ronda 1 al detectar el artefacto anterior. Sin lectura. |
| `v2_sonnet_mono_20260914-201935_1` | Parcial: crédito de la cuenta de Anthropic agotado en la llamada 71 (ronda 6) — "Your credit balance is too low to access the Anthropic API"; la recarga automática llegó después de la falla. Repetida (válida: `v2_sonnet_mono_20260914-212336_1`). |
| `v2_sonnet_mono_horizonte_20260914-202844_1`, `v2_opus_mono_20260914-202916_1`, `v2_opus_mono_horizonte_20260914-202947_1`, `v2_fable_mono_20260914-203019_1`, `v2_fable_mono_horizonte_20260914-203051_1` | Fallaron en la llamada 1 por el mismo motivo. Carpetas vacías. Las seis se relanzaron con el crédito repuesto. |
| `v2_grok_mono_20260914-205355_1` | Parcial: crédito de xAI agotado en la llamada 75 —el último turno de la ronda 10— ("has either used all available credits or reached its monthly spend"). 68 turnos y una votación válidos como muestra: nombres "Pacto del Umbral", "Pacto de la Costa y del Cuidado", "Pacto del Paso Corto", "Pacto del Socorro Inmediato". Repetida (válida: `v2_grok_mono_20260914-222832_1`). |
